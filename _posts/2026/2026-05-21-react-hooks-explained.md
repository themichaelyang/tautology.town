...
Naturally, this does not apply to components that return different JSX. In those cases, React should notice the tree has changed (by node type) and reinitialize local state.
